...
<img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061715114.png" alt="image-20221006171508933" style="zoom:50%;" />
...
<img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061715060.png" alt="image-20221006171526827" style="zoom: 33%;" />
...
![image-20221006171544322](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061715515.png)
...
\end{aligned} \right]=\left[ \begin{aligned}
  & A{{x}_{1}} \\ 
 & A{{x}_{\text{2}}} \\ 
 & {{v}_{1}}{{x}_{1}}+{{v}_{2}}{{x}_{2}} \\ 
\end{aligned} \right]$因此在射影变换下，理想点可以被射影为有线点。

理想点的仿射变换：$\left[ \begin{matrix}
   A & t  \\
   {{0}^{t}} & v  \\
\end{matrix} \right]\left[ \begin{aligned}
  & {{x}_{1}} \\ 
...
\end{aligned} \right]=\left[ \begin{aligned}
 ...
 & A{{x}_{\text{2}}} \\ 
 & 0 \\ 
\end{aligned} \right]$，在仿射变化下，理想点还是理想点。
...
![image-20221006171557927](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061715102.png)

![image-20221006171603275](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061716387.png)
...
![image-20221006171614907](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061716078.png)
...
<img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061716827.png" alt="image-20221006171626678" style="zoom:50%;" />
...
3D空间中的直线和2D的表达方式相差较大，在三维空间中直线的自由度为4，一种定义方式是用任意两个垂直平面上两个交点确定，一个交点有两个自由度。<img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061717827.png" alt="image-20221006171711644" style="zoom:50%;" />
...
2. Plucker矩阵表示法
   ...
   <img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061716750.png" alt="image-20221006171655689" style="zoom: 33%;" />
   ...
   \begin{align}
     & L=A{{B}^{T}}-B{{A}^{T}} \\ 
    & =\left[ \begin{matrix}
      {{a}_{1}}{{b}_{1}} & {{a}_{1}}{{b}_{2}} & {{a}_{1}}{{b}_{3}} & {{a}_{1}}{{b}_{4}}  \\
      {{a}_{2}}{{b}_{1}} & {{a}_{2}}{{b}_{2}} & {{a}_{2}}{{b}_{3}} & {{a}_{2}}{{b}_{4}}  \\
      {{a}_{3}}{{b}_{1}} & {{a}_{3}}{{b}_{2}} & {{a}_{3}}{{b}_{3}} & {{a}_{3}}{{b}_{4}}  \\
      {{a}_{4}}{{b}_{1}} & {{a}_{4}}{{b}_{2}} & {{a}_{4}}{{b}_{3}} & {{a}_{4}}{{b}_{4}}  \\
   \end{matrix} \right]-\left[ \begin{matrix}
      {{b}_{1}}{{a}_{1}} & {{b}_{1}}{{a}_{2}} & {{b}_{1}}{{a}_{3}} & {{b}_{1}}{{a}_{4}}  \\
      {{b}_{2}}{{a}_{1}} & {{b}_{2}}{{a}_{2}} & {{b}_{2}}{{a}_{3}} & {{b}_{2}}{{a}_{4}}  \\
      {{b}_{3}}{{a}_{1}} & {{b}_{3}}{{a}_{2}} & {{b}_{3}}{{a}_{3}} & {{b}_{3}}{{a}_{4}}  \\
      {{b}_{4}}{{a}_{1}} & {{b}_{4}}{{a}_{2}} & {{b}_{4}}{{a}_{3}} & {{b}_{4}}{{a}_{4}}  \\
   \end{matrix} \right] \\ 
    & =\left[ \begin{matrix}
      {{a}_{1}}{{b}_{1}}-{{b}_{1}}{{a}_{1}} & {{a}_{1}}{{b}_{2}}-{{b}_{1}}{{a}_{2}} & {{a}_{1}}{{b}_{3}}-{{b}_{1}}{{a}_{3}} & {{a}_{1}}{{b}_{4}}-{{b}_{1}}{{a}_{4}}  \\
      {{a}_{2}}{{b}_{1}}-{{b}_{2}}{{a}_{1}} & {{a}_{2}}{{b}_{2}}-{{b}_{2}}{{a}_{2}} & {{a}_{2}}{{b}_{3}}-{{b}_{2}}{{a}_{3}} & {{a}_{2}}{{b}_{4}}-{{b}_{2}}{{a}_{4}}  \\
      {{a}_{3}}{{b}_{1}}-{{b}_{3}}{{a}_{1}} & {{a}_{3}}{{b}_{2}}-{{b}_{3}}{{a}_{2}} & {{a}_{3}}{{b}_{3}}-{{b}_{3}}{{a}_{3}} & {{a}_{3}}{{b}_{4}}-{{b}_{3}}{{a}_{4}}  \\
      {{a}_{4}}{{b}_{1}}-{{b}_{4}}{{a}_{1}} & {{a}_{4}}{{b}_{2}}-{{b}_{4}}{{a}_{2}} & {{a}_{4}}{{b}_{3}}-{{b}_{4}}{{a}_{3}} & {{a}_{4}}{{b}_{4}}-{{b}_{4}}{{a}_{4}}  \\
   \end{matrix} \right] \\ 
    & =\left[ \begin{matrix}
      0 & {{a}_{1}}{{b}_{2}}-{{b}_{1}}{{a}_{2}} & {{a}_{1}}{{b}_{3}}-{{b}_{1}}{{a}_{3}} & {{a}_{1}}-{{b}_{1}}  \\
      {{a}_{2}}{{b}_{1}}-{{b}_{2}}{{a}_{1}} & 0 & {{a}_{2}}{{b}_{3}}-{{b}_{2}}{{a}_{3}} & {{a}_{2}}-{{b}_{2}}  \\
      {{a}_{3}}{{b}_{1}}-{{b}_{3}}{{a}_{1}} & {{a}_{3}}{{b}_{2}}-{{b}_{3}}{{a}_{2}} & 0 & {{a}_{3}}-{{b}_{3}}  \\
      {{b}_{1}}-{{a}_{1}} & {{b}_{2}}-{{a}_{2}} & {{b}_{3}}-{{a}_{3}} & 0  \\
   \end{matrix} \right] \\ 
   \end{align}
   $$
   ...
   \begin{aligned}
     & m=A\times B \\ 
    & =\left( \begin{matrix}
      {{a}_{2}}{{b}_{3}}-{{b}_{2}}{{a}_{3}}  \\
      {{a}_{3}}{{b}_{1}}-{{b}_{3}}{{a}_{1}}  \\
      {{a}_{1}}{{b}_{2}}-{{b}_{1}}{{a}_{2}}  \\
   \end{matrix} \right) \\ 
    & =\left( \begin{aligned}
     & {{l}_{23}} \\ 
    & {{l}_{31}} \\ 
...
3. Plucker直线表示法
   ...
   $$
   det[A,B,A',B']=l_{12}l_{34}'+l_{13}l_{42}'+l_{14}l_{23}'+l_{12}'l_{34}+l_{13}'l_{42}+l_{14}'l_{23}
   $$
...
| :------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----: | :------------------------------------------------: |
| 射影变换 | $\left[ \begin{matrix}  A & t  \\   {{v}^{T}} & v  \\\end{matrix} \right]$ | <img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061717849.png" alt="image-20221006171738807" style="zoom:25%;" /> | 15dof  |                接触表面的相交和相切                |
| 仿射变换 | $\left[ \begin{matrix}  A & t  \\   {{0}^{T}} & v  \\\end{matrix} \right]$ | <img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061717230.png" alt="image-20221006171751186" style="zoom:25%;" /> | 12dof  | 平面的平行性，体积比，形心，无穷远平面$\pi_\infty$ |
| 相似变换 | $\left[ \begin{matrix}  sR& t  \\   {{0}^{T}} & 1\\\end{matrix} \right]$ | <img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061718132.png" alt="image-20221006171800098" style="zoom:33%;" /> |  7dof  |            绝对二次曲线$\Omega_\infty$             |
| 欧式变换 | $\left[ \begin{matrix}  R& t  \\   {{0}^{T}} & 1\\\end{matrix} \right]$ | <img src="https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061718003.png" alt="image-20221006171807965" style="zoom:33%;" /> |  6dof  |                      体积形状                      |
...
$$
\cos \theta=\frac{\left(\mathbf{d}_{1}^{\top} \mathbf{d}_{2}\right)}{\sqrt{\left(\mathbf{d}_{1}^{\top} \mathbf{d}_{1}\right)\left(\mathbf{d}_{2}^{\top} \mathbf{d}_{2}\right)}}
$$
通用表达式：
$$
\cos \theta=\frac{\left(\mathbf{d}_{1}^{\top} \Omega_{\infty} \mathbf{d}_{2}\right)}{\sqrt{\left(\mathbf{d}_{1}^{\top} \Omega_{\infty} \mathbf{d}_{1}\right)\left(\mathbf{d}_{2}^{\top} \Omega_{\infty} \mathbf{d}_{2}\right)}}
$$
很明显若两线垂直，则有$d_1^T\Omega_\infty d_2=0$，这个可以通过二次曲线的共轭来表示；

![image-20221006171822515](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061718701.png)
...
$$
X_i'\times HX_i=\left( \begin{align}
  & y_{i}^{'}{{h}^{3T}}{{X}_{i}}-w_{i}^{'}{{h}^{\text{2}T}}{{X}_{i}} \\ 
 & w_{i}^{'}{{h}^{1T}}{{X}_{i}}-x_{i}^{'}{{h}^{3T}}{{X}_{i}} \\ 
 & x_{i}^{'}{{h}^{\text{2}T}}{{X}_{i}}-y_{i}^{'}{{h}^{1T}}{{X}_{i}} \\ 
\end{align} \right)=0
$$
（三）$h^{jT}X_i=X_i^Th^j$化简为：
$$
\left[ \begin{matrix}
   0 & -w_{i}^{'}{{X}_{i}^T} & y_{i}^{'}{{X}_{i}^T}  \\
   w_{i}^{'}{{X}_{i}^T} & 0 & -x_{i}^{'}{{X}_{i}^T}  \\
   -y_{i}^{'}{{X}_{i}^T} & x_{i}^{'}{{X}_{i}^T} & 0  \\
...
$$
||\epsilon	||=||Ah||=\epsilon_1^2+\epsilon_2^2+\epsilon_3^2+\cdots+\epsilon_n^2
\color{red}{不用开根号？}
$$

#### 2、几何距离--(欧氏距离)

![preview](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061714052.jpeg)
...
$$
\sum\limits_{i}d(\hat x,x_i)^2+d(\hat x',x_i')^2
$$
...
$$
\tilde \epsilon_i=T'X'\times T'HT^{-1}TX\\
=T'X'\times T'HX\\
=T^{'*}(X'\times HX)
$$
...
和上面同样的给出几何误差：
$$
d(\tilde{X}',\tilde H\tilde{X})=d(T'X'，T'HT^{-1}X)=d(T'X'，T'HX)=d(X',HX)
$$
...
\end{aligned} \right)
$$
![img](https://ssk-1314221533.cos.ap-guangzhou.myqcloud.com/202210061721047.jpeg)
...
![image-20220421143137754](C:%5CUsers%5Cssk%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20220421143137754.png)

$X_{cam}=R(\widetilde X-\widetilde C)$，其中$\widetilde C $表示摄像机中心在世界坐标系中心的位置，R是$3\times 3$的旋转矩阵。齐次坐标系下可以写成：
$$
X_{cam}=\left[\begin{array}{cc}\mathrm{R} & -\mathrm{R} {\widetilde{C}} \\ 0 & 1\end{array}\right]\left(\begin{array}{l}\mathrm{X} \\ \mathrm{Y} \\ \mathrm{Z} \\ 1\end{array}\right)=\left[\begin{array}{cc}\mathrm{R} & -\mathrm{R} {\widetilde{C}} \\ 0 & 1\end{array}\right] \mathbf{X}
$$
综合上面的结论有如下简化公式：
$$
x=KR[I|-\widetilde C]X
$$
...
一般摄像机可以写成$P=[M|p_4]$，其中$M$是$3 \times 3$的矩阵。如果$M$非奇异，那么则为有限摄像机。
...
![image-20220421204803815](C:%5CUsers%5Cssk%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20220421204803815.png)
...
点到线的反向投影：若已知一个点在图像中的坐标，求其在空间中哪些点可以映射到该点。在笛卡尔坐标系中摄像机中心和该点的连线$X(\lambda)=P^*x+\lambda C$，该线在无穷远平面的交点$D((M^{-1}x)^T,0)$两点连线$X(\mu)=\mu\left(\begin{array}{c}\mathrm{M}^{-1} \mathbf{x} \\ 0\end{array}\right)+\left(\begin{array}{c}-\mathrm{M}^{-1} \mathbf{p}_{4} \\ 1\end{array}\right)=\left(\begin{array}{c}\mathrm{M}^{-1}\left(\mu \mathbf{x}-\mathbf{p}_{4}\right) \\ 1\end{array}\right)$。

点的深度：点的深度考虑点在主轴方向上距离摄像机中心的距离$w=P^{3T}X=P^{3T}(X-C)$。

![image-20220422140733387](C:%5CUsers%5Cssk%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20220422140733387.png)
...
先类似于有限射影相机：
$$
P_0=KR[I|-\widetilde C]=\left[ \begin{matrix}
   {r^{1T}} & {-r^{1T}\widetilde C}  \\
   {r^{2T}} & {-r^{2T}\widetilde C}  \\
   {r^{3T}} & {-r^{3T}\widetilde C}  \\
\end{matrix} \right]
$$
旋转矩阵$R$，定位矩阵${\widetilde C}$。主射线的方向为$r^3$，那么当摄像机在一段时间$t$内以单位速度后移，在$t$时刻摄像机的矩阵为：
$$
P_{t}=\mathrm{K}\left[\begin{array}{cc}\mathbf{r}^{1 T} & -\mathbf{r}^{1 T}\left(\widetilde{{C}}-t \mathbf{r}^{3}\right) \\ \mathbf{r}^{2 T} & -\mathbf{r}^{2 T}\left(\widetilde{C}-t \mathbf{r}^{3}\right) \\ \mathbf{r}^{3 T} & -\mathbf{r}^{3 T}\left(\widetilde{{C}}-t \mathbf{r}^{3}\right)\end{array}\right]=\mathrm{K}\left[\begin{array}{cc}\mathbf{r}^{1 T} & -\mathbf{r}^{1 T} \widetilde{\mathbf{C}} \\ \mathbf{r}^{2 T} & -\mathbf{r}^{2 T} \widetilde{\mathbf{C}} \\ \mathbf{r}^{3 T} & d_{T}\end{array}\right]
$$
为了使图像大小不变，需要变焦。下面确定放大因子$k=d_t/d_0$。由此得出摄像机的矩阵。
$$
\mathrm{P}_{\mathrm{t}}=\mathrm{K}\left[\begin{array}{lll}
d_{t} / d_{0} & & \\
& d_{t} / d_{0} & \\
& & 1
\end{array}\right]\left[\begin{array}{cc}
\mathbf{r}^{1 T} & -\mathbf{r}^{1 T} \widetilde{\mathbf{C}} \\
\mathbf{r}^{2 T} & -\mathbf{r}^{2 \top} \widetilde{\mathbf{C}} \\
\mathbf{r}^{3 T} & d_{t}
\end{array}\right]=\frac{d_{t}}{d_{0}} \mathrm{~K}\left[\begin{array}{cc}
\mathbf{r}^{1 T} & -\mathbf{r}^{1 T} \widetilde{\mathbf{C}} \\
\mathbf{r}^{2 T} & -\mathbf{r}^{2 T} \widetilde{\mathbf{C}} \\
\mathbf{r}^{3 T} d_{0} / d_{t} & d_{T0}
\end{array}\right]
$$
当$t \rightarrow \infty$该矩阵变为（无穷远摄像机）
$$
P_{\infty}=\lim _{t \rightarrow \infty} P_{t}=K\left[\begin{array}{cc}
\mathbf{r}^{1 T} & -\mathbf{r}^{1 T} \widetilde{\mathbf{C}} \\
\mathbf{r}^{2 T} & -\mathbf{r}^{2 T} \widetilde{\mathbf{C}} \\
0^{\top} & d_{0}
\end{array}\right]
...
\alpha \mathbf{r}^{1}+\beta \mathbf{r}^{2} \\
1
\end{array}\right)
$$
...
$$
\mathbf{X}=\left(\begin{array}{c}
\alpha \mathbf{r}^{1}+\beta \mathbf{r}^{2}+\Delta r^3 \\
1
\end{array}\right)
$$
该情况下$P_0、P_\infty$在图像中的坐标为：
$$
x_{proj}=P_0X=K\left(\begin{array}{c}
\widetilde x\\
\widetilde y\\
d_0+\Delta
\end{array}\right)
...
$$
x_{affine}=P_\infty X=K\left(\begin{array}{c}
\widetilde x\\
\widetilde y\\
d_0
\end{array}\right)
...
$$
\tilde{x}=\alpha-r^{1 T} \tilde{C}, \tilde{y}=\beta-r^{2 T} \tilde{C}
$$

记标定矩阵：
$$
K=\left(\begin{array}{cc}
K_{2 \times 2} & \tilde{X}_{0} \\
0& 1
\end{array}\right)
$$
