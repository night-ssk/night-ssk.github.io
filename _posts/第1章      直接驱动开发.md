...
![Pasted image 20240402225056.png](../_post/pic/Pasted%20image%2020240402225056.png)
从驱动程序的角度来看
![Pasted image 20240402225036.png](../_post/pic/Pasted%20image%2020240402225036.png)
...
![Pasted image 20240331161750.png](../_post/pic/Pasted%20image%2020240331161750.png)
寄存器是32位的，但只用到了低5位。
...
需要将第三位取1设置成OUTPUT模式
![Pasted image 20240331161825.png](../_post/pic/Pasted%20image%2020240331161825.png)
**DR（数据寄存器）**
需要将第三位取1/0设置输出/不输出
